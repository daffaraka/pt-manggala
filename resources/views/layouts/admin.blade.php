...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <header class="app-header"><a class="app-header__logo" href="index.html">HCIS</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('img/pegawai.png')}}" width="50px" alt="User Image">
        <div>
          ...
          <p class="app-sidebar__user-designation">Developer Semua Aspek</p>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li class="treeview {{ request()->is('agama','negara','darah','keluarga') ? 'is-expanded' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            {{-- <li><a class="treeview-item {{ request()->is('penempatans') ? 'active' : '' }}" href="{{route('penempatans.index')}}"><i class="icon fa fa-circle-o"></i> Penempatan</a></li> --}}
